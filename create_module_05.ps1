$moduleDir = "c:\Users\apiwi\Downloads\Python and Doc\Python and Doc\Python_Version 2\Module_05_List_Processing"
if (-not (Test-Path -Path $moduleDir)) {
    New-Item -ItemType Directory -Path $moduleDir -Force
}

$lectureNbPath = Join-Path $moduleDir "01_Lecture_List_Processing.ipynb"
$labNbPath = Join-Path $moduleDir "02_Lab_Exercises.ipynb"
  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "1. การสร้างลิสต์ด้วยวงเล็บเหลี่ยม `[]`\n",
        "2. การหาจำนวนสมาชิกด้วยฟังก์ชัน `len()`\n",
        "3. การเชื่อมต่อลิสต์ด้วยเครื่องหมาย `+`\n",
        "4. การทำซ้ำลิสต์ด้วยเครื่องหมาย `*`\n",
        "5. การแก้ไขค่าในลิสต์ผ่านทางดัชนี (Index Assignment)\n",
        "\n",
    ...
    },
    {
      ...
      "outputs": [],
      "source": [
        "# 5.1 ตัวอย่างการใช้งานการดำเนินการพื้นฐานกับลิสต์\n",
        "\n",
        "# 1. การสร้างลิสต์ประเภทต่างๆ\n",
        "numbers = [10, 20, 30, 40, 50]\n",
        "names = [\"Somchai\", \"Somsri\", \"Somsak\"]\n",
        "mixed = [100, \"Python\", 3.14, True]\n",
        "empty_list = []\n",
        "\n",
        "# 2. การหาความยาวของลิสต์\n",
        "print(\"ความยาวของ numbers:\", len(numbers))\n",
        "\n",
        "# 3. การเข้าถึงและการแก้ไขค่าผ่านดัชนี\n",
        "print(\"สมาชิกตำแหน่งแรก:\", numbers[0])\n",
        "numbers[2] = 99  # เปลี่ยนค่าในดัชนีที่ 2 จาก 30 เป็น 99\n",
        "print(\"ลิสต์หลังแก้ไข:\", numbers)\n",
        "\n",
        "# 4. การเชื่อมต่อและการทำซ้ำลิสต์\n",
        "list_a = [1, 2]\n",
        "list_b = [3, 4]\n",
        "combined = list_a + list_b\n",
        "repeated = list_a * 3\n",
        "\n",
        "print(\"ผลจากการเชื่อมต่อลิสต์:\", combined)\n",
        "print(\"ผลจากการทำซ้ำลิสต์:\", repeated)\n"
      ]
    },
    {
      "cell_type": "markdown",
...
$nbL = $lectureJson | ConvertFrom-Json
$jsonL = $nbL | ConvertTo-Json -Depth 100
[System.IO.File]::WriteAllText($lectureNbPath, $jsonL, [System.Text.Encoding]::UTF8)

$nbLab = $labJson | ConvertFrom-Json
$jsonLab = $nbLab | ConvertTo-Json -Depth 100
[System.IO.File]::WriteAllText($labNbPath, $jsonLab, [System.Text.Encoding]::UTF8)

Write-Host "CREATED MODULE 05 FOLDER AND NOTEBOOKS SUCCESSFULLY!"
