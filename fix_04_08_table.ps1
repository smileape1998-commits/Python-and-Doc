  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "| Input (จากแป้นพิมพ์) | Output (ทางจอภาพ) |\n",
        "| :--- | :--- |\n",
        "| `2` | <pre style=\"font-family:monospace; margin:0;\"> *<br>***</pre> |\n",
        "| `3` | <pre style=\"font-family:monospace; margin:0;\">  *<br> * *<br>*****</pre> |\n",
        "| `8` | <pre style=\"font-family:monospace; margin:0;\">       *<br>      * *<br>     *   *<br>    *     *<br>   *       *<br>  *         *<br> *           *<br>***************</pre> |"
      ]
    },
    {
      "cell_type": "code",
...
Write-Host "FIXED 04-08 TABLE FORMATTING SUCCESSFULLY!"
