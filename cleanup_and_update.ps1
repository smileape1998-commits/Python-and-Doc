...
# Filter out any null cells if present
$cleanCells = @()
...
Write-Host "Index of Section 4.4: $idx_4_4"
...
if ($idx_4_4 -ge 0) {
    ...
    Write-Host "Warning: 4.4 cell index not found directly, replacing from 4.4"
}
...
Write-Host "CLEANUP AND UPDATE COMPLETED SUCCESSFULLY!"
